    ...
    def __init__(self, manage_page):
        ...
        class Manage:
            def __init__(self, Manage_window):
                ...
                # Coffee Image
                coffeeImage = Image.open('images\\inventory\\ecu2.jpg')
                ...
                # ITEM NAME AND ENTRY
                coffeeLabel = Label(coverFrame3, text="Items", bg='#ffffff', font=("yu gothic ui", 12, "bold"))
                ...
                coffeeName_entry.config(highlightbackground="#6b6a69", highlightcolor="#000000")
                ...
                typeName_entry.config(highlightbackground="#6b6a69", highlightcolor="#000000")
                ...
                price_entry.config(highlightbackground="#6b6a69", highlightcolor="#000000")
                ...
                coffee_tree.heading("CoffeeName", text="ITEM", anchor=N)
        ...
        class BillWindow:
            def __init__(self, top=None):
                ...
                self.coffeeImage = Image.open('images\\inventory\\ecu2.jpg')
