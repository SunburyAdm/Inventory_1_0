...
class AccountPage:
    def __init__(self, AccountSystem_window):
        ...
        # window Icon
        icon = PhotoImage(file='images\\inventory\\hitachi1.png')
        AccountSystem_window.iconphoto(True, icon)

        AccountSystem_window.title('SUNBURY INVENTORY')
        ...
        # ====== LOGO ==========
        logoIcon = Image.open('images\\inventory\\hitachi1.png')
        photo = ImageTk.PhotoImage(logoIcon)
        logo = Label(landing_page, image=photo, bg='#ffffff')
        logo.image = photo
        logo.place(x=20, y=45)

        brand_name = Label(landing_page, text='SUNBURY INVENTORY', bg='#ffffff', fg='#000000', font=("yu gothic ui", 15, "bold"))
        brand_name.place(x=83, y=53)

        text = Label(landing_page, text="Inventory rules", bg='#ffffff', font=("", 12, "bold"))
        text.place(x=20, y=140)
        txt = "• The inventory goes down the elevator  \nevery night\t\t\t \n\n• We want to turn our inventory faster " \
              "than \nour people\t"
        ...
        # ====== LOGO ==========
        coffeeImage = Image.open('images\\inventory\\inventory1.png')
        ...
        # Login Button
        login_button = Button(landing_page, text='Login', bg='#000000', font=("", 13, "bold"), bd=0, fg='white',
        ...
        # Sign Up Button
        signUp_button = Button(landing_page, text='Create New Account', bg='#000000', font=("", 13, "bold"), bd=0, fg='white',
                               cursor='hand2', activebackground='#4286f5', activeforeground='white',
        ...
        brand_name = Label(sign_in, text='SUNBURY INVENTORY', bg='#ffffff', fg='#000000', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)

        text = Label(sign_in, text="Sign in", bg='#ffffff', font=("", 12, "bold"))
        text.place(x=20, y=140)

        txt2 = "• Lorem ipsum dolor sit amet, consectetur \nadipiscing elit\t\t\t \n\n• sed do eiusmod tempor incididunt" \
        ...
        # ====== LOGO ==========
        coffeeImage = Image.open('images\\\\inventory\\Hitachi.png')
        photo = ImageTk.PhotoImage(coffeeImage)
        ...
        def login_all():
            # Admin
            conn1 = sqlite3.connect("./Database/SunburyInventory.db")
            ...
            # Guest
            conn2 = sqlite3.connect("./Database/SunburyInventory.db")
            ...
            # Employee
            conn3 = sqlite3.connect("./Database/SunburyInventory.db")
        ...
        loginButton = Button(sign_in, fg='#f8f8f8', text='Login', bg='#000000', font=("", 12, "bold"),
                             cursor='hand2', activebackground='#000000', command=login_all)
        ...
        def forgot_password():
            ...
            update_pass = Button(win, fg='#f8f8f8', text='Update Password', bg='#000000', font=("", 12, "bold"),
                                 cursor='hand2', activebackground='#000000', command=lambda: change_password())
            ...
            def change_password():
                db = sqlite3.connect("./Database/SunburyInventory.db")
                cur = db.cursor()
        ...
        brand_name = Label(sign_up, text='SUNBURY INVENTORY', bg='#ffffff', fg='#000000', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)

        text = Label(sign_up, text="SUNBURY INVENTORY", bg='#ffffff', font=("", 12, "bold"))
        text.place(x=20, y=140)
        txt3 = "• Lorem ipsum dolor sit amet, consectetur \nadipiscing elit\t\t\t \n\n• sed do eiusmod tempor incididunt" \
              "town \nipsum dolor sit amet            \t"
        ...
        def signup_all():
            ...
            if check_counter == 3:
                try:
                    connection = sqlite3.connect("./Database/SunburyInventory.db")
        ...
        signupButton = Button(sign_up, fg='#f8f8f8', text='Create Account', bg='#000000', font=("", 12, "bold"),
                              cursor='hand2', activebackground='#000000', command=signup_all)
