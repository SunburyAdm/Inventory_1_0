...
class InventoryPage:
    def __init__(self, Manage_window):
        ...
        coffeName_entry.config(highlightbackground="#6b6a69", highlightcolor="#000000")
        ...
        discountLabel = Label(coverFrame3, text="EMPLOYEE NAME", bg='#ffffff', font=("yu gothic ui", 12, "bold"))
        ...
        coffee_tree.heading("CashierName", text="EMPLOYEE NAME", anchor=N)
