...
root = Tk()
# root.resizable(0, 0)
image = PhotoImage(file='images\\hitachi.png')
...
welcome_label = Label(text='          SUNBURY INVENTORY', bg='#ffffff', font=("yu gothic ui", 15, "bold"), fg='black')
...
exit_btn = Button(text='x', bg='#ffffff', command=lambda: exit_window(), bd=0, font=("yu gothic ui", 16, "bold"),
