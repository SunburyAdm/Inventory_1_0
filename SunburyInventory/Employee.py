...
class SecondPage:
    def __init__(self, manage_page):
        ...
        with sqlite3.connect("./Database/SunburyInventory.db") as db:
            cur = db.cursor()
        ...
        def checkInOut_window(Event=None):
        ...
        class Manage:
            def __init__(self, Manage_window):
                ...
                Manage_window.title("Item Management System")

                # window Icon
                icon = PhotoImage(file='images\\inventory\\hitachi2.png')
                Manage_window.iconphoto(True, icon)

                # Navigating through windows
                product_page = Frame(Manage_window)
                checkinout_page = Frame(Manage_window)

                for frame in (product_page, checkinout_page):
                ...
                # ====== MENU BAR ==========
                logoIcon = Image.open('images\\inventory\\hitachi2.png')
                ...
                # ========== MANAGE BUTTON =======
                manage_button = Button(product_page, text='Manage', bg='#4286f5', font=("", 13, "bold"), bd=0,
                                       fg='#ffffff',
                                       cursor='hand2', activebackground='#4286f5', activeforeground='#7a7a7a',
                                       command=manage)
                ...
                self.button6.configure(activebackground="#4286f5")
                self.button6.configure(cursor="hand2")
                self.button6.configure(foreground="#ffffff")
                self.button6.configure(background="#4286f5")
                ...
                # Manage items Label
                manageCoffee = Label(coverFrame2, text='MANAGE ITEMS', font=("yu gothic ui", 13, "bold"), bg='#ffffff',
                                     fg='#000000')
                ...
                productImg = Label(coverFrame2, image=photo, bg='#ffffff')
                productImg.image = photo
                productImg.place(x=100, y=35)
                ...
                idName_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6b6a69",
                                     font=("", 11, 'bold'), textvariable=item_id)
                idName_entry.place(x=22, y=44, width=40, height=24)
                idName_entry.config(highlightbackground="#6b6a69", highlightcolor="#000000")
                ...
                itemName_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6b6a69",
                                         font=("", 12, 'bold'), textvariable=item_name)
                itemName_entry.place(x=10, y=70, width=225, height=34)
                itemName_entry.config(highlightbackground="#6b6a69", highlightcolor="#000000")

                # ITEM LOCATION AND ENTRY
                locationLabel = Label(coverFrame3, text="LOCATION", bg='#ffffff', font=("yu gothic ui", 12, "bold"))
                locationLabel.place(x=90, y=105)

                locationName_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6b6a69",
                                       font=("", 12, 'bold'), textvariable=location)
                locationName_entry.place(x=10, y=135, width=225, height=34)
                locationName_entry.config(highlightbackground="#6b6a69", highlightcolor="#000000")
                ...
                #discountName_entry.config(highlightbackground="#6b6a69", highlightcolor="#000000")

                # DESCRIPTION AND ENTRY
                descriptionLabel = Label(coverFrame3, text="DESCRIPTION", bg='#ffffff', font=("yu gothic ui", 12, "bold"))
                descriptionLabel.place(x=90, y=170)

                description_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6b6a69",
                                    font=("", 12, 'bold'), textvariable=description)
                description_entry.place(x=10, y=270, width=225, height=34)
                description_entry.config(highlightbackground="#6b6a69", highlightcolor="#000000")
                ...
                inStock_entry.place(x=10, y=200, width=225, height=34)
                inStock_entry.config(highlightbackground="#6b6a69", highlightcolor="#000000")
                ...
                def product_info(ev):
                    ...
                    product_data = item_tree.item(viewInfo)
                    row = product_data['values']
                    item_id.set(row[0])
                    item_name.set(row[1])
                    location.set(row[2])
                    #discount.set(row[3])
                ...
                def add_product():
                    if item_id.get() == "":
                        ...
                        cur.execute("INSERT INTO Item_Category values(?,?,?,?,?)",
                                    (item_id.get(), item_name.get(), location.get(), description.get(), in_stock.get()))
                        conn.commit()
                        conn.close()
                        show_all()
                        messagebox.showinfo("Success", "Sunbury Records Added Successfully")
                ...
                def update():
                    ...
                    cur = conn.cursor()
                    cur.execute(
                        "UPDATE Item_Category set item_name=?,location=?,description=?,in_stock=? where "
                        "item_id=?",
                        (item_name.get(), location.get(), description.get(), in_stock.get(),item_id.get()))
                    conn.commit()
                    conn.close()
                    show_all()
                    # self.Reset()
                    messagebox.showinfo("Success", "Sunbury inventory Record updated Successfully")

                def delete_block():
                    messagebox.showinfo("Warning", "You need admin rights, ask your supervisor")

                self.button3 = Button(coverFrame3)
                self.button3.place(relx=0.539, rely=0.849, width=86, height=25)
                self.button3.configure(relief="flat")
                self.button3.configure(overrelief="flat")
                self.button3.configure(activebackground="#808080")
                ...
                self.button5.configure(activebackground="#4286f5")
                self.button5.configure(cursor="hand2")
                self.button5.configure(foreground="#ffffff")
                self.button5.configure(background="#4286f5")
                ...
                # PURCHASE BUTTON
                checkFrame = LabelFrame(coverFrame, bg='#ffffff', bd='2.4')
                checkFrame.place(x=200, y=10, width=100, height=80)

                checkLabel = Label(checkFrame, text="Check I/O", font=("yu gothic ui", 12, 'bold'), bg='#ffffff')
                checkLabel.place(x=10, y=0)

                checkIcon = Image.open('images\\marketplace.png')
                photo = ImageTk.PhotoImage(checkIcon)
                checkInOut = Button(checkFrame, image=photo, bg='#ffffff', width=93, height=52, bd=0, cursor='hand2',
                                  activebackground="#ffffff", command=lambda: checkInOut_window())
                checkInOut.image = photo
                checkInOut.place(x=0, y=22)

                # PRODUCTS BUTTON
                productsFrame = LabelFrame(coverFrame, bg='#ffffff', bd='2.4')
                productsFrame.place(x=50, y=10, width=100, height=80)

                productsLabel = Label(productsFrame, text="Items", font=("yu gothic ui", 12, 'bold'), bg='#ffffff')
                ...
                item_tree.heading("Location", text="LOCATION", anchor=N)
                item_tree.heading("Description", text="DESCRIPTION", anchor=N)
                ...
                item_tree.bind("<ButtonRelease-1>", product_info)
                show_all()
        ...
        class ProductItem:
            def __init__(self, item, location, qty):
        ...
        class BillWindow:
            def __init__(self, top=None):
                ...
                # ========== MANAGE BUTTON =======
                manage_button = Button(biller, text='Manage', bg='#4286f5', font=("", 13, "bold"), bd=0,
                                       fg='#ffffff',
                                       cursor='hand2', activebackground='#4286f5', activeforeground='#7a7a7a',
                                       command=manage)
                manage_button.place(x=150, y=15)
                ...
                # PURCHASE BUTTON
                checkFrame = LabelFrame(biller, bg='#ffffff', bd='2.4')
                checkFrame.place(x=690, y=80, width=100, height=80)
                ...
                self.productImage = Image.open('images\\inventory\\ecu2.jpg')
                photo = ImageTk.PhotoImage(self.productImage)
                self.productImg = Label(self.coverFrame2, image=photo, bg='#ffffff')
                self.productImg.image = photo
                self.productImg.place(x=220, y=30)
                ...
                self.genBill_no = Label(self.coverFrame6, text='Ticket Number', font=("yu gothic ui", 10, "bold"),
                                        bg='#ffffff', fg='#000000')
                ...
                self.genBill_date = Label(self.coverFrame6, text='Ticket Date', font=("yu gothic ui", 10, "bold"),
                                          bg='#ffffff', fg='#000000')
                self.genBill_date.place(relx=0.180, rely=0.256)

                self.genCom_number = Label(self.coverFrame6, text='Badge Number', font=("yu gothic ui", 10, "bold"),
                                          bg='#ffffff', fg='#000000')
                ...
                self.transaction = Label(biller)
                self.transaction.place(x=45, y=538)
                self.transaction.configure(font="-family {Poppins Light} -size 11")
                self.transaction.configure(foreground="#000000")
                self.transaction.configure(text="Transaction")
                self.transaction.configure(background="#ffffff")
                ...
                self.description = Label(biller)
                self.description.place(x=45, y=374)
                self.description.configure(font="-family {Poppins Light} -size 11")
                ...
                self.location_method = Label(biller)
                self.location_method.place(x=45, y=313)
                self.location_method.configure(font="-family {Poppins Light} -size 11")
                self.location_method.configure(foreground="#000000")
                self.location_method.configure(text="Location")
                self.location_method.configure(background="#ffffff")

                self.badge_number = Label(biller)
                self.badge_number.place(x=45, y=258)
                self.badge_number.configure(font="-family {Poppins Light} -size 11")
                self.badge_number.configure(foreground="#000000")
                self.badge_number.configure(text="Badge Number")
                self.badge_number.configure(background="#ffffff")

                self.employee_name = Label(biller)
                self.employee_name.place(x=45, y=205)
                self.employee_name.configure(font="-family {Poppins Light} -size 11")
                self.employee_name.configure(foreground="#000000")
                self.employee_name.configure(text="Employee Name")
                self.employee_name.configure(background="#ffffff")
                ...
                self.entry3.configure(highlightbackground="#6b6a69", highlightcolor="#4286f5")
                self.entry3.configure(textvariable=cust_search_bill)
                self.search_txt = "Enter ticket Number to Search............"
                ...
                self.button2.configure(activebackground="#4286f5")
                self.button2.configure(cursor="hand2")
                self.button2.configure(foreground="#ffffff")
                self.button2.configure(background="#4286f5")
                ...
                self.button3.configure(relief="flat")
                self.button3.configure(overrelief="flat")
                self.button3.configure(activebackground="#4286f5")
                self.button3.configure(cursor="hand2")
                self.button3.configure(foreground="#ffffff")
                self.button3.configure(background="#4286f5")
                self.button3.configure(font="-family {Poppins SemiBold} -size 10")
                self.button3.configure(borderwidth="0")
                ...
                self.button7.configure(activebackground="#4286f5")
                self.button7.configure(cursor="hand2")
                self.button7.configure(foreground="#ffffff")
                self.button7.configure(background="#4286f5")
                ...
                self.button8.configure(activebackground="#4286f5")
                self.button8.configure(cursor="hand2")
                self.button8.configure(foreground="#ffffff")
                self.button8.configure(background="#4286f5")
                ...
                self.button9.configure(activebackground="#4286f5")
                self.button9.configure(cursor="hand2")
                self.button9.configure(foreground="#ffffff")
                self.button9.configure(background="#4286f5")
                ...
                find_category = "SELECT location FROM Item_Category"
                ...
                self.combo1.option_add("*TCombobox*Listbox.selectBackground", "#4286f5")
                ...
                btn_print = Button(top, text="""Print""", command=lambda: print_area(self.Scrolledtext1.get('1.0', END)),
                                   ...
                                   font="-family {Poppins SemiBold} -size 10", bg='#000000', activebackground="#000000")
            ...
            def get_category(self, Event):
                ...
                self.combo2.set('')
                self.combo3.set('')
                find_subcat = "SELECT description FROM Item_Category WHERE location = ?"
            ...
            def get_subcat(self, Event):
                ...
                self.combo3.set('')
                find_product = "SELECT item_name FROM Item_Category WHERE location = ? and description = ?"
            ...
            def add_to_cart(self):
                ...
                if strr.find('Total') == -1:
                    ...
                    if (product_name != ""):
                        ...
                        find_mrp = "SELECT description, in_stock FROM Item_Category WHERE item_name = ?"
                        ...
                        if product_qty.isdigit() == True:
                            if (stock - int(product_qty)) >= 0:
                                ...
                                item = ProductItem(product_name, mrp, int(product_qty))
                    ...
                    if (product_name != ""):
                        product_qty = self.entry4.get()
                        find_mrp = "SELECT description, in_stock, item_id FROM Item_Category WHERE item_name = ?"
                        cur.execute(find_mrp, [product_name])
                        results = cur.fetchall()
                        stock = results[0][1]
                        mrp = results[0][0]
                    ...
                    if(cust_name.get()==""):
                        ...
                        if strr.find('Total')==-1:
                            ...
                            with sqlite3.connect("./Database/SunburyInventory.db") as db:
                                cur = db.cursor()
                            insert = (
                                "INSERT INTO History(number, date, employee_name, badge_number, details) VALUES(?,?,?,?,?)"
                            )
            ...
            def search_bill(self):
                find_bill = "SELECT * FROM History WHERE number = ?"
        ...
        manage_page.bind("<Return>", checkInOut_window)
